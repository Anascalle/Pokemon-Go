...
async function getCharacter() {
    ...
    const character = new Character(data.id, data.name, data.sprites.other["official-artwork"].front_default, [type1, type2],data.weight,data.height,abilities, data.base_experience,data.stats,moves);
